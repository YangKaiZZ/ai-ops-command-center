...
- `/orders/<id>`: one order: customer, total, statuses, what was in it (items, quantities, how many are still to ship, prices), every agent decision about it with the reasoning and its rating, and "Open in Shopify". "Back to orders" returns to the filtered list it came from
